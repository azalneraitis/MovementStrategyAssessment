...
public class MovementAssessmentFragment extends Fragment {
    ...
    public static MovementAssessmentFragment newInstance() {
        return new MovementAssessmentFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_movement_assessment, container, false);
    }
